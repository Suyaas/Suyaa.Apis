...
const setUserFocus = function (isFocus) {
    this.isUserFocus = isFocus;
}

// 设置密码焦点
const setPwdFocus = function (isFocus) {
    this.isPwdFocus = isFocus
}
</script>
    ...
    <div class="login-box" id="login">
        <div class="login-rect">
            ...
            <div class="login-form">
                <p :class="{ selected: isUserFocus }"><img src="login/user.png" /><input placeholder="输入用户名" type="text"
                        maxlength="50" @focus="setUserFocus(true)" @blur="setUserFocus(false)" /><br /></p>
                <p :class="{ selected: isPwdFocus }"><img src="login/password.png" /><input placeholder="输入密码"
...
.login-box {
    ...
    overflow: hidden;
    border-radius: 10px;
    box-shadow: 1px 1px 50px #222222;
}
...
.login-form .selected {
    ...
    box-shadow: 0px 0px 1px #ff6600 !important;
}
